...
import random
from Zaid import group_count

 
fotoplay = "https://telegra.ph/file/5e85d83a31e5314a4207f.jpg"
ngantri = "https://telegra.ph/file/5e85d83a31e5314a4207f.jpg"
...
def ytsearch(query: str):
    try:
        ...
        videoid = data["id"]
        return [songname, url, duration, thumbnail, videoid, length, id]
...
btnn =[[Button.inline("✯ Close ✯", data="cls")]]
...
async def play(event):
    ...
    # print('_----------------------', event.text[5:], title)
    tmp_text = event.text[19:]
